...
<div class="page-container">
	<div class="page-content">
		<div class="container">
			...
			<div id="prefix_16075061353" class="Metronic-alerts alert alert-success fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>Email forwarded successfully..</div>
			<?php endif; ?>
			<div class="row">
				<div class="col-md-12">
